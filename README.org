...
*** TODO Explain some details, including ~syntax-violation~.

With this macro, we can finally define and test our newly written ~tree-accumulate~:
...
#  LocalWords:  preprocessor expander homoiconic matchers
